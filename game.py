...
def verify_guess():
    while True:
        ...
        # if take_guess.player_guess - random_number.number <= 10:
        #     return "You're hot!!"
        # elif take_guess.player_guess - random_number.number <= 20:
        #     return "You're warm!"
        # elif take_guess.player_guess - random_number.number <= 30:
        #     return "You're cold"
        # else:
